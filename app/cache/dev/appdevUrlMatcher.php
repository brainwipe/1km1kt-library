...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?<name>[^/]+)$#s', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'ThousandMonkeys\\LibraryBundle\\Controller\\DefaultController::indexAction',)), array('_route' => 'ThousandMonkeysLibraryBundle_homepage'));
        }
        ...
        // version_show
        if (0 === strpos($pathinfo, '/version') && preg_match('#^/version/(?<versionId>[^/]+)$#s', $pathinfo, $matches)) {

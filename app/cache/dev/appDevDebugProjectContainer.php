...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'phpbb.security.authentication.listener' => 'getPhpbb_Security_Authentication_ListenerService',
            'phpbb.security.authentication.provider' => 'getPhpbb_Security_Authentication_ProviderService',
            'phpbb_user_provider' => 'getPhpbbUserProviderService',
            ...
            'security.authentication.listener.phpbb.all' => 'getSecurity_Authentication_Listener_Phpbb_AllService',
            'security.authentication.manager' => 'getSecurity_Authentication_ManagerService',
            'security.authentication.provider.phpbb.all' => 'getSecurity_Authentication_Provider_Phpbb_AllService',
            'security.authentication.trust_resolver' => 'getSecurity_Authentication_TrustResolverService',
            'security.channel_listener' => 'getSecurity_ChannelListenerService',
            'security.context' => 'getSecurity_ContextService',
            'security.encoder_factory' => 'getSecurity_EncoderFactoryService',
            'security.firewall' => 'getSecurity_FirewallService',
            'security.firewall.map.context.all' => 'getSecurity_Firewall_Map_Context_AllService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'F:/Web/1km1kt-library/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('F:/Web/1km1kt-library/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'F:/Web/1km1kt-library/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'F:/Web/1km1kt-library/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_b8d3b199f502a353d7bd099f3734a841');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_b8d3b199f502a353d7bd099f3734a841');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_b8d3b199f502a353d7bd099f3734a841');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'F:\\Web\\1km1kt-library\\src\\ThousandMonkeys\\LibraryBundle\\Entity')), 'ThousandMonkeys\\LibraryBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('ThousandMonkeysLibraryBundle' => 'ThousandMonkeys\\LibraryBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('F:/Web/1km1kt-library/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'F:/Web/1km1kt-library/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '10c1b63410c4dcab5c19e54220ae28feb');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('F:/Web/1km1kt-library/app/logs/dev.log', 100, true);
    }
    ...
    /**
     * Gets the 'phpbb.security.authentication.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return ThousandMonkeys\PHPBBAuthBundle\Security\Firewall\PHPBBListener A ThousandMonkeys\PHPBBAuthBundle\Security\Firewall\PHPBBListener instance.
     */
    protected function getPhpbb_Security_Authentication_ListenerService()
    {
        return $this->services['phpbb.security.authentication.listener'] = new \ThousandMonkeys\PHPBBAuthBundle\Security\Firewall\PHPBBListener($this->get('security.context'), $this->get('security.authentication.manager'));
    }

    /**
     * Gets the 'phpbb.security.authentication.provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return ThousandMonkeys\PHPBBAuthBundle\Security\Authentication\PHPBBProvider A ThousandMonkeys\PHPBBAuthBundle\Security\Authentication\PHPBBProvider instance.
     */
    protected function getPhpbb_Security_Authentication_ProviderService()
    {
        return $this->services['phpbb.security.authentication.provider'] = new \ThousandMonkeys\PHPBBAuthBundle\Security\Authentication\PHPBBProvider('', 'F:/Web/1km1kt-library/app/cache/dev/security/nonces');
    }

    /**
     * Gets the 'phpbb_user_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return ThousandMonkeys\PHPBBAuthBundle\Security\User\PHPBBUserProvider A ThousandMonkeys\PHPBBAuthBundle\Security\User\PHPBBUserProvider instance.
     */
    protected function getPhpbbUserProviderService()
    {
        return $this->services['phpbb_user_provider'] = new \ThousandMonkeys\PHPBBAuthBundle\Security\User\PHPBBUserProvider($this);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:F:/Web/1km1kt-library/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'F:/Web/1km1kt-library/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'F:/Web/1km1kt-library/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    /**
     * Gets the 'security.authentication.listener.phpbb.all' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return ThousandMonkeys\PHPBBAuthBundle\Security\Firewall\PHPBBListener A ThousandMonkeys\PHPBBAuthBundle\Security\Firewall\PHPBBListener instance.
     */
    protected function getSecurity_Authentication_Listener_Phpbb_AllService()
    {
        return $this->services['security.authentication.listener.phpbb.all'] = new \ThousandMonkeys\PHPBBAuthBundle\Security\Firewall\PHPBBListener($this->get('security.context'), $this->get('security.authentication.manager'));
    }

    /**
     * Gets the 'security.authentication.provider.phpbb.all' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return ThousandMonkeys\PHPBBAuthBundle\Security\Authentication\PHPBBProvider A ThousandMonkeys\PHPBBAuthBundle\Security\Authentication\PHPBBProvider instance.
     */
    protected function getSecurity_Authentication_Provider_Phpbb_AllService()
    {
        return $this->services['security.authentication.provider.phpbb.all'] = new \ThousandMonkeys\PHPBBAuthBundle\Security\Authentication\PHPBBProvider($this->get('phpbb_user_provider'), 'F:/Web/1km1kt-library/app/cache/dev/security/nonces');
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'ThousandMonkeys\\PHPBBAuthUser\\Security\\User\\PHPBBUser' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.all' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'), 'security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/login$'), 'security.firewall.map.context.secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/'))), $this->get('event_dispatcher'));
    }

    /**
     * Gets the 'security.firewall.map.context.all' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_Firewall_Map_Context_AllService()
    {
        $a = $this->get('security.context');
        $b = $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE);

        return $this->services['security.firewall.map.context.all'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('phpbb_user_provider')), 'all', $b, $this->get('event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => $this->get('security.authentication.listener.phpbb.all'), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'all', NULL, NULL, NULL, $b));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('phpbb_user_provider')), 'secured_area', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $d, 'secured_area', $g, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('login_path' => '_demo_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $b), array('check_path' => '_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '_demo_login', false), NULL, NULL, $b));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('F:/Web/1km1kt-library/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('F:/Web/1km1kt-library/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('F:/Web/1km1kt-library/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('F:/Web/1km1kt-library/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'F:/Web/1km1kt-library/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => 'F:/Web/1km1kt-library/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'F:/Web/1km1kt-library/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'F:/Web/1km1kt-library/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('F:\\Web\\1km1kt-library\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('F:\\Web\\1km1kt-library\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('F:\\Web\\1km1kt-library\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('F:\\Web\\1km1kt-library\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('F:\\Web\\1km1kt-library\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('F:\\Web\\1km1kt-library\\src\\ThousandMonkeys\\LibraryBundle/Resources/views', 'ThousandMonkeysLibrary');
        $instance->addPath('F:\\Web\\1km1kt-library\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('F:\\Web\\1km1kt-library\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('F:\\Web\\1km1kt-library\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('F:/Web/1km1kt-library/app/Resources/views');
        $instance->addPath('F:\\Web\\1km1kt-library\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('10c1b63410c4dcab5c19e54220ae28feb');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'F:/Web/1km1kt-library/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('F:/Web/1km1kt-library/app/cache/dev/assetic/assets');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => $this->get('security.authentication.provider.phpbb.all'), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('phpbb_user_provider'), new \Symfony\Component\Security\Core\User\UserChecker(), 'secured_area', $this->get('security.encoder_factory'), true)), true);
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'F:/Web/1km1kt-library/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'F:\\Web\\1km1kt-library\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'F:/Web/1km1kt-library/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'F:/Web/1km1kt-library/app/cache/dev',
            'kernel.logs_dir' => 'F:/Web/1km1kt-library/app/logs',
            'kernel.bundles' => array(
                ...
                'ThousandMonkeysLibraryBundle' => 'ThousandMonkeys\\LibraryBundle\\ThousandMonkeysLibraryBundle',
                'ThousandMonkeysPHPBBAuthBundle' => 'ThousandMonkeys\\PHPBBAuthBundle\\ThousandMonkeysPHPBBAuthBundle',
            ...
            'database_port' => NULL,
            'database_name' => '2km2kt',
            'database_user' => '2km2kt',
            'database_password' => '2km2kt',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'localhost',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => '10c1b63410c4dcab5c19e54220ae28feb',
            'phpbb_forum_url' => 'http://localhost/1km1kt/phpbb',
            'phpbb_fourm_path' => 'E:/Web/1KM1KT/phpbb3/',
            'phpbb_db_server' => 'localhost',
            'phpbb_db_catalog' => '1km1kt',
            'phpbb_db_user' => '1km1kt',
            'phpbb_db_password' => '1km1kt',
            'phpbb_db_prefix' => 'phpbb',
            'phpbb_db_anonymous' => 1,
            'version_upload_absolute_path' => 'E:/Web/1km1kt-library/web/bundles/thousandmonkeyslibrary/documents',
            'version_upload_web_path' => 'http://localhost/2km2kt/bundles/thousandmonkeyslibrary/documents',
            ...
            'debug.container.dump' => 'F:/Web/1km1kt-library/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => '10c1b63410c4dcab5c19e54220ae28feb',
            ...
            'session.save_path' => 'F:/Web/1km1kt-library/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'F:\\Web\\1km1kt-library\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:F:/Web/1km1kt-library/app/cache/dev/profiler',
            ...
            'router.resource' => 'F:/Web/1km1kt-library/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'F:/Web/1km1kt-library/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'F:/Web/1km1kt-library/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'F:/Web/1km1kt-library/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'F:/Web/1km1kt-library/app/../web',
            'assetic.write_to' => 'F:/Web/1km1kt-library/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'F:/Web/1km1kt-library/app/cache/dev/doctrine/orm/Proxies',
